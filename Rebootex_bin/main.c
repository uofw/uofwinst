...
int _sub_3E80(int arg0)
{
    if (*(unsigned int*)(arg0 + 0x130) == 0xC01DB15D)
        return 1;
    return sub_3E80(arg0);
}

int _check(unsigned char * addr, void * arg2, int (*func)(unsigned char*, void*))
{
    if (*(unsigned int*)(addr + 0x130) == 0xC01DB15D || func == NULL)
        return _sceKernelCheckExecFile(addr, arg2);
    return func(addr, arg2);
}

int _decrypt(char * prx, unsigned int size, unsigned int * newsize, int (*func)(char*, unsigned int, unsigned int*))
{
    if (*(unsigned int*)(prx + 0x130) == 0xC01DB15D || func == NULL)
        return _DecryptPSP(prx, size, newsize);
    return func(prx, size, newsize);
}

int PatchLoadCore(void * arg1, void * arg2, void * arg3, int (* module_bootstart)(void *, void *, void *))
{
	_sw((((int)(_DecryptPSP) >> 2) & 0x03FFFFFF) | 0x0C000000, (unsigned int)(module_bootstart) + g_offs->loadcore_patch.DecryptPSPCall1); // EF73E85B
	...
	_sw(0x00403021, (unsigned int)(module_bootstart) + (0x58E0 - 0xAF8)); // move $a2, $v0
	_sw((((int)(_check) >> 2) & 0x03FFFFFF) | 0x0C000000, (unsigned int)(module_bootstart) + (0x58E8 - 0xAF8));

	_sw((((int)(_sub_3E80) >> 2) & 0x03FFFFFF) | 0x0C000000, (unsigned int)(module_bootstart) + (0x3E00 - 0xAF8));
	_sw((((int)(_sub_3E80) >> 2) & 0x03FFFFFF) | 0x0C000000, (unsigned int)(module_bootstart) + (0x3F58 - 0xAF8));
	_sw((((int)(_sub_3E80) >> 2) & 0x03FFFFFF) | 0x0C000000, (unsigned int)(module_bootstart) + (0x58F8 - 0xAF8));
	_sw((((int)(_sub_3E80) >> 2) & 0x03FFFFFF) | 0x0C000000, (unsigned int)(module_bootstart) + (0x5908 - 0xAF8));

	_sw(0x00403821, (unsigned int)(module_bootstart) + (0x5944 - 0xAF8));
	_sw((((int)(_decrypt) >> 2) & 0x03FFFFFF) | 0x0C000000, (unsigned int)(module_bootstart) + (0x5950 - 0xAF8));
	...
	sub_3E80 = (void *)((unsigned int)(module_bootstart) + (0x3E80 - 0xAF8));
